...
* Only Db honors readPreference settings, removed app.js legacy readPreference settings due to user confusion.
...
* Added disableDriverBSONSizeCheck property to app.js for people who wish to push the inserts to the limit (Issue #609).
